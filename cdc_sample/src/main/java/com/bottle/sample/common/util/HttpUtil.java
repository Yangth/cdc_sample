...
public class HttpUtil {
     ...
     * 连接超时时间
     */
    private static final int CONN_TIMEOUT = 1000*30;
    /**
     * 请求超时时间
     */
    ...
    public static ResponseEntity<String> httpPost(String url,String json){
        ...
        HttpHeaders httpHeaders = initHeader();
        //发送请求
       return toPost(restTemplate,url,httpHeaders,json);
    }
    ...
    public static String httpPost(String url,Map<String,Object> header,String json){
        ...
        //发送请求
       return toPost(restTemplate,url,httpHeaders,json).getBody();
    }
     ...
     * @return
     */
    private static ResponseEntity<String> toPost(RestTemplate restTemplates,String url,HttpHeaders httpHeaders,String json){
        HttpEntity<String> httpEntity = new HttpEntity<>(json,httpHeaders);
        ResponseEntity<String> responseEntity = restTemplates.exchange(url, HttpMethod.POST,httpEntity,String.class);
