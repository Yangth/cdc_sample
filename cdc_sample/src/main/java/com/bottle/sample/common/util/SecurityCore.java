 ...
 */
    private String sKey = "ewHteUwF0AYdTk3X";
    private String ivParameter = "ewHteUwF0AYdTk3X";
...
//        }
    ...
    //test
//    public static void main(String[] args) throws Exception {        // 需要加密的字串
//        String cSrc = "";        // 加密
...
//        String DeString = SecurityCore.getInstance().decrypt("Rk+hPgDck1IZqqrvyAHOzQ==");
